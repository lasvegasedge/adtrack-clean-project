...
export default function AppRoiCalculator() {
      ...
      <div className="container mx-auto py-8 print:py-2">
        <div className="space-y-6 print:space-y-2">
          <div className="text-center mb-8 print:mb-2">
            <h1 className="text-4xl font-bold tracking-tight print:text-2xl">ROI Calculator</h1>
          </div>
