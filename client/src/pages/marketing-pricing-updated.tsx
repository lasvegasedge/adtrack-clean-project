        ...
        <div className="max-w-3xl mx-auto mt-16 bg-white rounded-lg shadow-sm border p-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <p className="text-gray-600">
                We accept all major credit cards, including Visa, Mastercard, American Express, and Discover. We also support payment via ACH transfer for annual plans.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-gray-900 text-gray-300 py-12">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h4 className="text-lg font-semibold mb-4 text-white">AdTrack</h4>
